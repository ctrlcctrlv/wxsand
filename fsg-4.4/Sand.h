...
extern unsigned char trans_neighbor[MAXNUMBEROFELEMENTS][MAXNUMBEROFELEMENTS]
                                   [100];
...
extern unsigned char pexplosionelement[MAXNUMBEROFELEMENTS]
                                      [MAXNUMBEROFELEMENTS];
...
extern wxTreeItemId
    penSelectionElements[MAXNUMBEROFELEMENTS * MAXNUMBEROFELEMENTS];
extern wxTreeItemId
    groupSelectionIds[MAXNUMBEROFELEMENTS * MAXNUMBEROFELEMENTS];
